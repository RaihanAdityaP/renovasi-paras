    ...
    <section id="tentang" className="py-32 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="bg-gradient-to-br from-pink-50 via-white to-pink-50 rounded-2xl p-12 md:p-16 shadow-xl border border-pink-100">
            ...
            <p className="text-xl md:text-2xl text-gray-700 leading-relaxed text-center font-light mt-6">
