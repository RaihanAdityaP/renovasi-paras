  ...
  return (
    <section id="social" className="py-32 bg-gradient-to-br from-pink-500 via-pink-600 to-pink-700">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p className="text-xl md:text-2xl text-white/90 max-w-3xl mx-auto leading-relaxed font-light mb-16">
        ...
        <div className="flex justify-center gap-6">
          ...
          <a
            ...
            className="group inline-flex items-center gap-4 bg-white text-pink-600 px-10 py-6 rounded-lg font-bold text-xl hover:bg-pink-50 transition-all transform hover:scale-105 shadow-2xl"
          >
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="group inline-flex items-center gap-4 bg-white text-green-600 px-10 py-6 rounded-lg font-bold text-xl hover:bg-green-50 transition-all transform hover:scale-105 shadow-2xl"
          >
            <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 24 24">
